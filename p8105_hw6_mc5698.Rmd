...
```
The bootstrap distributions for `log_beta` and `r_squared` are approximately normal, with `log_beta` centered around 2 and `r_squared` around 0.9, indicating stable estimates. The 95% confidence interval for `r_squared` (0.894 to 0.927) suggests a strong model fit, while the interval for `log_beta` (1.965 to 2.059) shows that the estimates are consistent.
